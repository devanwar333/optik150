            ...
            <div class="modal-content">
              ...
              <form id="update">
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label for="nama">Nama Barang : </label>
                    <input type="text" id="nabar" name="barang_nama" value="" class="form-control" placeholder="Nama Barang" required  <?php echo $this->session->userdata('level')=="admin" ? "":"disabled" ?>>
                  </div>

                  <div class="form-group">
                    <label for="satuan">Satuan : </label>
                    <select required name="barang_satuan" id="satuan" class="form-control"  <?php echo $this->session->userdata('level')=="admin" ? "":"disabled" ?>>
                      <option value="buah">Buah</option>
                    </select>
                  </div>
                  <div class="form-group">
                    <label for="hargapokok">Harga Pokok : </label>
                    <input type="text" id="harpok" name="barang_harpok" value="" class="form-control" placeholder="Harga Pokok" required  <?php echo $this->session->userdata('level')=="admin" ? "":"disabled" ?>>
                  </div>
                  <div class="form-group">
                    <label for="hargajual">Harga Jual : </label>
                    <input type="text" id="harjul" name="barang_harjul" value="" class="form-control" placeholder="Harga Jual" required  <?php echo $this->session->userdata('level')=="admin" ? "":"disabled" ?>>
                  </div>
                  <div class="form-group">
                    <label for="hargajual">Harga Cabang : </label>
                    <input type="text" name="barang_harga_cabang" value="" class="form-control" placeholder="Harga Jual" required  <?php echo $this->session->userdata('level')=="admin" ? "":"disabled" ?>>
                  ...
                  <div class="form-group">
                    <label for="stok">Stok : </label>
                    <input type="text" id="stok" name="barang_stok" value="" class="form-control" placeholder="Stok" required <?php echo $this->session->userdata('level')=="admin" || $this->session->userdata('level')=="kasir"  ? "":"disabled" ?>>
                  </div>
                  <div class="form-group">
                    <label for="minimalstok">Minimal Stok : </label>
                    <input type="text" id="min_stok" name="barang_min_stok" value="" class="form-control" placeholder="Minimal Stok" required  <?php echo $this->session->userdata('level')=="admin" ? "":"disabled" ?>>
                  </div>

                  <div class="form-group">
                    <label for="serial">Serial Number : </label>
                    <input type="text" id="sn" name="serial_number" value="" class="form-control" placeholder="Serial Number" required  <?php echo $this->session->userdata('level')=="admin" ? "":"disabled" ?>>
                  </div>

                  <div class="form-group">
                    <label for="Kategori">Kategori : </label>
                    <select required name="barang_kategori_id" id="kategori" class="form-control"  <?php echo $this->session->userdata('level')=="admin" ? "":"disabled" ?>>
