<div class="container-fluid">
	<!-- Page Heading -->
	<h1 class="h3 mb-2 text-gray-800">Laporan Penjualan Per Barang</h1>
	<!-- DataTales Example -->
    ...
    <td><img src="<?php// echo base_url().'assets/img/kop_surat.png'?>"/></td>
					...
					<table border="1" align="center" style="width:900px;margin-bottom:20px;">
						<thead>
						<tr>
							<?php $barang_tampung = $this->db->query("select * from tbl_barang where barang_id='$barang'")->row_array(); ?>
							<th colspan="11" style="text-align:left;">Laporan Per Barang : <?= $barang_tampung['barang_nama']; ?> </th>
						</tr>
						<tr>
