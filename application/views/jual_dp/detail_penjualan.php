...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <h6 class="m-0 font-weight-bold text-primary text-center">KETERANGAN PENJUALAN
      </h6>
    </div>
    <br>
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-bordered" width="100%" cellspacing="0">
          ...
          <tr>
            ...
            <td>:</td>
            <td><?php echo date("d M Y", strtotime($jual['jual_tanggal'])); ?></td>
          </tr>
          <tr>
            <td>Customer</td>
            <td>:</td>
          ...
          <tr>
            <td>Kurang</td>
            <td>:</td>
            <td>Rp. <?= number_format(abs($jual['jual_kembalian'])); ?></td>
          </tr>
        </table>
      </div>
    </div>
...
<div class="modal fade" id="add_hutang_karyawan">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <?php echo form_open('jual_dp/bayar') ?>
